...
<div class="rmdtip">
<p>For example, if I picked a hypothetical variable <code>sushi</code>, representing the number of times the respondent had eaten sushi in the last year, I might use “sushi” or “Japanese food” as search terms.</p>
</div>
