...
**Personnel:** This vignette should be completed by **all** students. Make sure to follow the instructions for the section you are enrolled in.
```
...
```{block, type = "rmdtip"}
**Deliverables:** Information from this vignette will be included in your memo (see Vignette 2).
```
