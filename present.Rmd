...
```{r, echo=FALSE}
presentationGroups <- data.frame(
  Pair = c(1,2,3,4,5, 6),
  Section = c("SOC 5050", "SOC 5050", "SOC 4015", "SOC 4015", "SOC 4015", "SOC 4015"),
  Names = c("Branson & Raymond", "Jeanna & Via", "Nadia & Carter", "Addie & Mae", "Nick & Logan", "Janae & Carissa"),
  stringsAsFactors = FALSE
)
knitr::kable(
  presentationGroups, booktabs = TRUE,
  caption = "SOC 4015/5050 Final Project Peer Review Groups"
)
```
